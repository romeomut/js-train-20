...
Vehicle.prototype.toString = function(){return `${this.brand} ${this.model} ${this.year} ${this.mileage}`}
...
let boundFunction = car.drive.bind(myTruck)
boundFunction(100)
/*
 ...
 * | batteryCapacity | 100               |
 */
let ecar = new ElectricCar('Tesla', 'Model S', 2020, 10000, 100)
